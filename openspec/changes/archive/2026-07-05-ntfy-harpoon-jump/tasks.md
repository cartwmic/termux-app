...
- [x] 1.1 Add a VIEW deep-link intent-filter to `TermuxActivity` for scheme
...
- [x] 2.1 Add a jump handler that parses `termux://zellij-jump/<pane-id>`,
...
- [x] 2.2 Wire intent delivery: handle the jump intent in both the initial
...
- [x] 3.1 Add a JVM unit test for the pane-id extraction / URI parsing logic
